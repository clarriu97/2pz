    ...
    <>
      <div className="section">
        ...
        <p className="hint">
          ...
          capital across 23 physical lounges. Not "leadership" in general: this is the one role that
          signs a lease, funds a refit, or lets a site go.
        </p>
        ...
        <p className="hint" style={{ marginTop: 9 }}>
          The three questions this tool has to answer in a portfolio review: which sites are earning
          their footprint, where are we paying rent twice for the same customer, and where is there
          demand we do not reach.
        </p>
      </div>
      ...
      <div className="section">
        ...
        <p className="hint">
          ...
          public proxy — and each one is labelled in the UI with where it came from, so a number is
          never mistaken for a fact it is not.
        </p>
            ...
            <div key={tier} style={{ marginBottom: 10 }}>
              ...
              {provByTier[tier].map((f) => (
                <div key={f} className="legend-item" style={{ alignItems: "flex-start" }}>
                  <code
                    style={{ fontSize: 10, color: "var(--text-dim)", flex: "none", width: 130 }}
                  >
                    {f}
                  </code>
                  <span style={{ fontSize: 10.5, color: "var(--text-faint)" }}>
      ...
      <div className="section">
        ...
        <p className="hint">
          ...
          exactly. A committee has to defend a lease decision; "the model said so" is not a defence.
        </p>
        ...
        <p className="hint" style={{ marginTop: 9 }}>
          All of the above lives in one file, <code>pipeline/config.py</code>. Nothing is hard-coded
          anywhere else, so re-tuning the portfolio's risk appetite is a one-file change and this
      ...
      <div className="section">
        ...
        <ul className="caveats">
          <li>
            ...
            grade-separated grid the gap is smaller than in a European city, but a lounge behind a
            creek or a single bridge is over-credited.
          </li>
          <li>
            ...
            distribution. The direction of that signal is illustrative; the <em>count</em> of rivals
            is real.
          </li>
          <li>
            <strong>Demand is a built-form proxy.</strong> Residential, retail and premium-venue
            density from OSM, not census population or income. It under-reads newly built districts
            and over-reads tourist strips.
          </li>
          <li>
            <strong>Momentum and chair utilisation are simulated</strong> and seeded from the branch
            id, so they are reproducible but not real. They are in the model to show where an
            operational feed would attach, not to drive a decision today.
          </li>
          <li>
            <strong>Trust the geometry, question the weights.</strong> Overlap area, distances and
            competitor counts are computed from real coordinates and are as good as the inputs. The
            weights that turn them into a label are a stated management judgement, which is exactly
            why they sit in one editable file.
          </li>
        </ul>
      </div>
